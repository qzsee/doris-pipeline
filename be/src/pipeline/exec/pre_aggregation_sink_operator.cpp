...
PreAggSinkOperator::PreAggSinkOperator(PreAggSinkOperatorTemplate* operator_template,
...
bool PreAggSinkOperatorTemplate::is_sink() const {
    return true;
}

bool PreAggSinkOperatorTemplate::is_source() const {
    return false;
}
} // namespace doris::pipeline